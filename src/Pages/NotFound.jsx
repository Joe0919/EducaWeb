...
import { BotonNew, MainPadding } from "../Components/UI";
      ...
      <Container>
        <LeftSection>
          <div className="inner-content">
            <Heading>404</Heading>
            <Subheading>
              Lo Sentimos, no pudimos encontrar la página que busca. Intentete
              otra dirección
              <div className="btn-content">
                <Link to={`/`} title="Ir a Inicio">
                  <BotonNew>Ir a Inicio</BotonNew>
                </Link>
              </div>
            </Subheading>
          </div>
...
const backgroundGradient = "linear-gradient(#0C0E10, #446182)";
const backgroundGroundColor = "#0C0E10";
const leftSectionWidth = "40%";
const rightSectionWidth = "50%";
const mediaQueryMaxWidth = "770px";

const Content404 = styled(MainPadding)`
  padding: 0vh 15vh;
`;

const Noche = styled.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
const FondoNoche = styled.div`
  position: absolute;
  bottom: 0;
  width: 100%;
  height: 25vh;
  background: ${backgroundGroundColor};
